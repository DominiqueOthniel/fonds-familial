...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  onSetRole: (cb) => ipcRenderer.on("set-role", (_e, role) => cb(role)),
});
...
contextBridge.exposeInMainWorld("apiComptes", {
  ...
  deposer: (membreId, type, montant) =>
    ipcRenderer.invoke("deposer", membreId, type, montant),
  retirer: (membreId, type, montant) =>
    ipcRenderer.invoke("retirer", membreId, type, montant),
  getCautionsParMembre: (idMembre) =>
    ipcRenderer.invoke("get-cautions-par-membre", idMembre),
